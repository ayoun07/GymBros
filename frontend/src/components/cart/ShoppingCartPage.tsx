    ...
    <div className="mb-32">
      {!dataCart.length ? (
        ...
        <div className="flex max-md:flex-col gap-6 flex-row">
          <section className="h-fit sm:w-full flex flex-col gap-6 mb-32 relative">
            {isOpen && (
            ...
            {dataCart.map((value: any) => (
              <div
                key={value.id}
                className="bg-[#F8F7F4] rounded-2xl shadow-2xl w-full h-fit flex flex-row justify-between"
              >
          ...
          <section className="flex flex-col bg-[#F8F7F4] shadow-2xl min-w-130 h-135 rounded-2xl gap-8 p-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-row justify-between w-full bg-gray-200 rounded-2xl">
                <input type="text" placeholder="votre code promo" className=" w-full rounded-r-none p-4 rounded-2xl outline-none" name="" id="" />
                <button className="cursor-pointer active:bg-[#63acd6] text-center bg-[#5390b3] hover:bg-[#63acd6] rounded-r-2xl  text-white p-2">Appliquer</button>
              </div>
            </div>
          </section>
        </div>
